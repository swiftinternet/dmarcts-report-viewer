...
function tmpl_page ($body, $reportid, $host_lookup = 1, $sort_order, $dom_select, $domains = array(),$css_bs, $css_cust, $org_select, $orgs = array(), $per_select, $periods = array() ) {
    ...
    $html[] = "    <link rel='stylesheet' href='$css_bs'>";
    $html[] = "    <link rel='stylesheet' href='$css_cust'>";
    $html[] = "  </head>";
...
if(!isset($css_cust)) {
  $css_cust="css/default.css";
  $css_bs="css/bootstrap.min.css";
}
